const howToHelpInfo = [
  {
    title: 'YWCA',
    src:
      'https://www.ywcaworks.org/sites/default/files/styles/large/public/2020-03/Virus%20icon%20COVID%20Feature%203_2.png?itok=etrtNzo-',
    ...
    link: 'https://www.ywca.org/ywca-usa-covid-19-emergency-response-message/',
  },
  {
    title: 'United Way',
    src:
      'https://upload.wikimedia.org/wikipedia/en/thumb/a/a9/United_Way_Logo.svg/1200px-United_Way_Logo.svg.png',
  ...
  {
    title: 'National PPE Coalition',
    src: 'https://www.ppecoalition.com/assets/images/ppe-logo.jpg',

    desc:
      '"A National Unified Leadership response to the urgent shortages of Personal Protective Equipment"',
    link: 'https://www.ppecoalition.com/',
  },
  {
  ...
  },
  {
    title: 'UNICEF',
    src:
      'https://www.unicef.org/georgia/sites/unicef.org.georgia/files/styles/press_release_feature/public/unicef-for-every-child-logo.png?itok=SmnazCaN',

    desc:
      '"UNICEF is on the front lines, fighting the novel coronavirus with supplies, support and lifesaving information."',
    link: 'https://www.unicefusa.org/',
  },
];

export default howToHelpInfo;
